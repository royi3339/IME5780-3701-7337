...
public class Plane extends Geometry {
    ...
    /**
     * <b> {@link Plane} with {@link Color} and {@link Material} constructor. </b>
     *
    ...
    /**
     * <b> {@link Plane} {@link Color} constructor. </b>
     *
     * @param color     <b> the {@link Color} of the {@link Plane} </b>
     * @param h         <b> the {@link Point3D} of the {@link Plane} </b>
     * @param normalVec <b> normal {@link Vector} of the {@link Plane} </b>
    ...
    public Plane(Point3D a, Point3D b, Point3D c) {
        this(a, b.subtract(c).crossProduct(b.subtract(a)).normalized()); // using the Plane constructor, with point and vector.
    }
