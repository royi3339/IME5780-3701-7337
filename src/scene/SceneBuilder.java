...
public class SceneBuilder {
    ...
    public void loadSceneFromFile(File fileName) {
        try {
...
/*
   ...
   /* public Render(String name) {
        try {
            File fXmlFile = new File(System.getProperty("user.dir") + "/" + name);
            ...
            System.out.println("----------------------------");
            Node nNode = doc.getElementsByTagName("scene").item(0);

            Render eElement = (Render) nNode;
