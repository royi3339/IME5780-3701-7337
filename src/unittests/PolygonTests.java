...
public class PolygonTests {
    ...
    public void testConstructor() {
        ...
        try {
            ...
            fail("TC02: Constructed a polygon with wrong order of vertices");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ...
            fail("TC03: Constructed a polygon with vertices that are not in the same plane");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ...
            fail("TC04: Constructed a concave polygon");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ...
            fail("TC10: Constructed a polygon with vertix on a side");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ...
            fail("TC11: Constructed a polygon with vertix on a side");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ...
            fail("TC12: Constructed a polygon with vertix on a side");
        } catch (IllegalArgumentException e) {}
    ...
    public void testGetNormal() {
        ...
        assertEquals("TC01: Bad normal to triangle", new Vector(sqrt3, sqrt3, sqrt3), pl.getNormal(new Point3D(0, 0, 1)));
    }
