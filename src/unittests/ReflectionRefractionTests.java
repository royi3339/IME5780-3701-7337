...
public class ReflectionRefractionTests {
    ...
    public void numOfObjectsTest() {
        ...
        Scene scene = new Scene("Object Test scene");
        scene.setDistance(10000);
        scene.setBackground(Color.BLACK);
        scene.setAmbientLight(new AmbientLight(new Color(255, 255, 255), 0.1));

        Camera c1 = new Camera(new Point3D(-150, -4620, 90), new Vector(1300, 5800, 150), new Vector(-5800, 1300, 0));
        Camera c2 = new Camera(new Point3D(0, -450, -7000), new Vector(20, 7, 100), new Vector(-100, 0, 20));
        Camera c3 = new Camera(new Point3D(0, -450, -5900), new Vector(20, 200, 100), new Vector(-100, 0, 20));
        ...
        imagesWriter4K(true, cameraList, scene);
    }

    /**
     * helper method for the test which checking if we want the pictures in 4K resolution.
     *
